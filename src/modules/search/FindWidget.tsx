...
import { ArrowDown01Icon, ArrowUp01Icon, Cancel01Icon, ReplaceIcon } from "@hugeicons/core-free-icons";
...
export function FindWidget({ isOpen, onClose, searchAddon, editorView, showReplace }: Props) {
  ...
  const handleToggle = (setter: (v: boolean) => void, nextVal: boolean, field: "cs" | "ww" | "rx") => {
    setter(nextVal);
