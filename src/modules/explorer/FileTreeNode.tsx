...
/**
 * Renders a single tree row. Deliberately non-recursive — `VirtualizedTreeList`
 * flattens the visible tree (via `buildTreeRows`) and renders one of these per
 * visible row through `useVirtualizer`, so only rows actually on screen exist
 * in the DOM regardless of how many directories are expanded.
 */
